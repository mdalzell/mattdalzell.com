I was born and raised in the Chicago area, growing up on a steady diet of Polish sausage and lousy Bears quarterbacks. Since graduating with a degree in computer science from Northwestern University, I have worked as a software engineer specializing in web development. I'm currently part of the Brand Integrations and Solutions team at Bread Financial, where I work on the React apps supporting their brand partners.
...
* Collaborated with enterprise architects to define a cloud infrastructure blueprint for frontend applications using AWS services, including ECS with Fargate, API Gateway, and ELB.
...
* Improved Bread's engineer interview experience by creating new questions to assess a candidate's frontend coding and system design ability in a fair and unbiased manner.
