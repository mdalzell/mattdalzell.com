...
skills:
  sections:
    - title: Frontend
      description: React, Typescript, Next.js, Tailwind CSS, JavaScript/ES6+, HTML5, CSS 3
    - title: Backend
    ...
    - title: Testing
      description: Cypress, Vitest, Jest
    - title: Tools
      description: git, VS Code, GitHub, Postman, JIRA, Slack
